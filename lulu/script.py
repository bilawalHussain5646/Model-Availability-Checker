...
def FetchBrands(keyword):
    ...
    input_elements = brand_box.find_elements(By.CSS_SELECTOR,"span.facet__list__text")

    
    for el in input_elements:
    # Get the value of the "value" attribute
        
        value_attribute = el.find_element(By.CSS_SELECTOR,"span.facet__list__text_label").get_attribute("textContent")
        value_attribute = value_attribute.split("\xa0")[0]
...
class App:
    ...
    def __init__(self, root):
        ...
        ClickBtnLabel["text"] = "LULU Crawler"
